...
export const ui: Record<Locale, Dict> = {
  en: {
    meta: {
      title: 'Bekhruz Makhmudov — Founder & Team Lead · Senior Flutter Developer, Tashkent',
      description:
        'Bekhruz Makhmudov is a founder and mobile team lead from Tashkent, Uzbekistan — a senior Flutter developer with 7+ years of experience building cross-platform mobile apps and Java (Spring Boot) backends.',
  ...
  ru: {
    meta: {
      title: 'Бехруз Махмудов — основатель и тимлид · Senior Flutter-разработчик, Ташкент',
      description:
        'Бехруз Махмудов — основатель и руководитель мобильной команды из Ташкента; senior Flutter-разработчик с опытом 7+ лет: кроссплатформенные мобильные приложения и бэкенды на Java (Spring Boot).',
  ...
  uz: {
    meta: {
      title: 'Behruz Mahmudov — asoschi va jamoa rahbari · Senior Flutter dasturchi, Toshkent',
      description:
        "Behruz Mahmudov — asoschi va Toshkentlik mobil jamoa rahbari: 7+ yillik tajribali senior Flutter dasturchi, krossplatforma mobil ilovalar va Java (Spring Boot) backendlar.",
